...
> 🎓 **졸업논문** [졸업논문 S1-6 PDF 보기](%EC%A1%B8%EC%97%85%EB%85%BC%EB%AC%B8%20S1-6(%EC%9D%B4%EA%B1%B4%ED%9D%AC%2C%20%EC%9D%B4%EA%B2%BD%ED%9B%88%2C%20%EB%A5%98%EC%8A%B9%ED%95%98%2C%20%EC%A0%84%EC%A4%80%ED%98%B8).pdf)
...
- 온라인 비동기 처리 구조는 Celery 기반으로 설계되었으나, 현재 공개 저장소에는 Redis broker 설정 및 관련 실행 코드 일부가 포함되어 있지 않습니다. 따라서 README의 아키텍처 설명과 달리, 공개 저장소만으로는 해당 비동기 처리 환경이 완전하게 재현되지 않을 수 있습니다.
